 ...
 * 模板方法设计模式
 */
public abstract class CallBackHandler implements InitializingBean {
    ...
    public JSONObject upload0102Handler(JSONObject object,String mid,String[] binaryData,String hexstr,byte[] b,String keyvalue){
        throw new UnsupportedOperationException();
    }

    public JSONObject upload0103Handler(JSONObject object,String mid,String[] binaryData,String hexstr,byte[] b,String keyvalue){
        throw new UnsupportedOperationException();
    }
